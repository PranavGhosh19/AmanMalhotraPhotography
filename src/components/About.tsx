    ...
    <section id="about" className="py-24 bg-card">
      <div className="container mx-auto px-6 md:px-12 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        <div className="order-2 lg:order-1 relative aspect-[3/4] w-full max-w-lg mx-auto lg:mx-0">
          <div className="absolute inset-0 border-2 border-primary/20 -translate-x-6 translate-y-6 -z-10"></div>
          <Image
        ...
        <div className="order-1 lg:order-2 space-y-8">
          <div className="space-y-4">
            <h2 className="font-headline text-4xl md:text-5xl font-bold tracking-tight">
              The Art of <span className="text-secondary italic">Storytelling</span>
            </h2>
          ...
          <div className="grid grid-cols-2 gap-8 pt-4">
            <div>
              <p className="font-headline text-3xl font-bold text-secondary">8+</p>
              <p className="text-xs uppercase tracking-widest text-muted-foreground">Years Experience</p>
            </div>
            <div>
              <p className="font-headline text-3xl font-bold text-secondary">500+</p>
