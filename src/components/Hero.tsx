      ...
      <div className="container mx-auto px-6 md:px-12 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        <div className="z-10 space-y-8 text-center lg:text-left animate-fade-up">
          <div className="space-y-2">
            <p className="text-primary text-xs uppercase tracking-[0.3em] font-bold">Aman Malhotra Photography</p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 pt-4">
            <Button asChild className="group h-14 px-8 rounded-none bg-primary text-primary-foreground hover:bg-primary/90 text-sm tracking-[0.2em] uppercase transition-all duration-300">
              <a href="#portfolio">
                View Portfolio <ArrowRight className="ml-2 w-4 h-4 transition-transform group-hover:translate-x-1" />
              </a>
            </Button>
            <Button variant="outline" asChild className="h-14 px-8 rounded-none border-primary/50 text-primary hover:bg-primary hover:text-primary-foreground text-sm tracking-[0.2em] uppercase transition-all duration-300">
        ...
        <div className="relative aspect-[3/4] lg:aspect-square w-full max-w-2xl mx-auto lg:mx-0 animate-fade-up delay-200">
          ...
          <div className="relative h-full w-full overflow-hidden shadow-2xl border border-white/5">
            <Image
